...
/**
 * getTrustedOrigins
 * WHAT: Trusted origins for CSRF purposes — the same allowlist lib/cors.mjs uses for CORS,
 *       since both answer "who is allowed to make authenticated cross-origin requests to us."
 */
