...
export const AuditAction = {
  ...
  ORG_USER_DELETED: 'org.user_deleted',
  ENTERPRISE_CONNECTION_CREATED: 'enterprise.connection_created',
  ENTERPRISE_CONNECTION_UPDATED: 'enterprise.connection_updated',
  ENTERPRISE_CONNECTION_DELETED: 'enterprise.connection_deleted',
 ...
 * @param {string} event.userRole - Role of user (admin)
