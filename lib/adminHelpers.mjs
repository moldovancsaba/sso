 ...
 * @param {boolean} options.requireSuperAdmin - Legacy flag; requires admin role (default: false)
...
export function withAdminMutation(handler, options = {}) {
  return async (req, res) => {
    try {
      ...
      // Legacy compatibility: "requireSuperAdmin" now maps to admin role.
      if (options.requireSuperAdmin && admin.role !== 'admin') {
