...
export async function createMagicToken(email, ttlSeconds = 900, redirectUri = null) {
...
export async function consumeMagicToken(token) {
  ...
  if (!timingSafeStringEqual(sigPart, expectedSig)) return { ok: false, error: 'bad_signature' }
