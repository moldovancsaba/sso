...
10) Backfill UUIDs for existing users in production (one-time)
   ...
   - Priority: P1
11) Redeploy v5.14.0 and validate admin login in production (login/validate/logout)
   - Owner: Platform
   - Expected Delivery: 2025-09-15T18:00:00.000Z
   - Priority: P1
12) Add fast-fail MongoDB client timeouts + 503 mapping; bump to v5.14.0 and redeploy
   - Owner: Platform
